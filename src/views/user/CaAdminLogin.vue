<template>
  <div id="htlogin">
    ...
    <div class="header">
      ...
      <div class="text">
        <p>教育部留学服务中心</p>
        <p>统一用户身份认证系统(<span>内部用户登录</span>)</p>
      </div>
    </div>
    <!--中间-->
...
<!--            </div>-->
          ...
          <ul class="login-list">
            <li>
              ...
              <p><a target="_blank" href="/static/UserManual.doc" download="UserManual.doc">软证书使用手册及常见问题</a></p>
            </li>
            <li>
              <img src="../../../public/images/l2.png" alt="" />
              <p><a target="_blank" href="/static/RZS.zip" download="RZS.zip">管理工具及驱动下载</a></p>
            </li>
          </ul>
        </div>
      </div>
